...
public class UIController {
    ...
    private void initializeHyperparameters(){
        ...
        for(Hyperparameters parameter: Hyperparameters.values()){
            hyperparametersVBox.getChildren().addAll(createHyperparametersRow(parameter.getRawValue(), parameter.getName(), parameter.getDescription()));
        }
    }
